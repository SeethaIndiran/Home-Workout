...
class IntermediateExerciseAdapter(val fragment: Fragment, val context: Context):RecyclerView.Adapter<IntermediateExerciseAdapter.ExerciseViewHolder>() {
        ...
        holder.itemView.apply {
            ...
            setOnClickListener {
                if(fragment is TrainingFragment){
                    fragment.navigatingToWorkoutTypeFragmentForIntermediate(position)
                }
            }
        }
    }
